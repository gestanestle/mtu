...
class Student_Record (models.Model):
    student_no = models.OneToOneField(Student, on_delete=models.CASCADE)
...
class UserManager(BaseUserManager):
    def create_user(self, email, password, **other_fields):
        ...
        user = self.model(email=self.normalize_email(email), password=password, **other_fields)
...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    REQUIRED_FIELDS = ['student_no', 'user_name']
